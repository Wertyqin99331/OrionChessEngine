...
impl Board {
    pub(crate) fn generate_pseudo_legal_moves(&self, side: Side, buf: &mut MoveBuffer) {
        buf.clear();
        ...
        for handler in generate_pseudo_legal_moves_handlers {
            handler(self, side, buf);
        }
    }

    pub(crate) fn generate_legal_moves(&mut self, side: Side, buf: &mut MoveBuffer) {
        self.generate_pseudo_legal_moves(side, buf);
...
fn generate_pseudo_legal_knight_moves(board: &Board, side: Side, buf: &mut MoveBuffer) {
    generate_leaper_pseudo_legal_moves(board, side, Piece::Knight, get_knight_attacks_mask, buf)
}

fn generate_pseudo_legal_bishop_moves(board: &Board, side: Side, buf: &mut MoveBuffer) {
    generate_sliding_pseudo_legal_moves(board, side, Piece::Bishop, get_bishop_attacks_mask, buf)
}

fn generate_pseudo_legal_rook_moves(board: &Board, side: Side, buf: &mut MoveBuffer) {
    generate_sliding_pseudo_legal_moves(board, side, Piece::Rook, get_rook_attacks_mask, buf)
}

fn generate_pseudo_legal_queen_moves(board: &Board, side: Side, buf: &mut MoveBuffer) {
    generate_sliding_pseudo_legal_moves(board, side, Piece::Queen, get_queen_attacks_mask, buf)
}

fn generate_pseudo_legal_king_moves(board: &Board, side: Side, buf: &mut MoveBuffer) {
    generate_leaper_pseudo_legal_moves(board, side, Piece::King, get_king_attacks_mask, buf)
}

fn generate_castling_moves(board: &Board, side: Side, buf: &mut MoveBuffer) {
